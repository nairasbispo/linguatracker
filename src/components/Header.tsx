          ...
          {showStatusTooltip && (
            ...
            >
              ...
              <p className="text-[11px] text-slate-500 leading-relaxed mb-2">
                Live database synchronized. Click to open the Firebase diagnostic and testing status panel.
              </p>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          {user ? (
            <button
              ...
              title="Authenticated account - click for details"
            >
            ...
            <button
              ...
              title="Click to view Firebase status or sign in with Google"
            >
